...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <input value={todo.id} className="form-control w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
            <input id="wd-todo-completed" type="checkbox" checked={todo.completed} className="form-check-input float-start"
                    onChange={(e) => setTodo({ ...todo, completed: e.target.checked }) }/>
            <label htmlFor="wd-todo-completed" className="form-check-label ms-1"> Completed </label>
            <br /><br /><hr />
